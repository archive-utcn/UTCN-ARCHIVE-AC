...
architecture arh of FIFO_4X8 is
 
shared variable tEmpty, tFull: std_logic;
shared variable Pos: integer range 0 to 8;
type mem is array ( 7 downto 0 ) of std_logic_vector(3 downto 0);
shared variable M: mem:=("0000", "0000", "0000", "0000","0000","0000","0000","0000");
