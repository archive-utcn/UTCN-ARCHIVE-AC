...
begin	
	...
	--DivFrecvAnim5: Hz10_Div port map(boardCLK,RST,fastCLK);
	DivFrecvDisp: HZ100_Div port map(boardCLK,RST,dispCLK);
	...
	EnableDMUX: dmux_8_enable port map(CONTROL,anim_1_enbl,anim_2_enbl,anim_3_enbl,anim_4_enbl,anim_5_enbl,anim_6_enbl,anim_7_enbl,anim_8_enbl);	
	AddressMUX: mux_8 port map(anim_1_addr,anim_2_addr,anim_3_addr,anim_4_addr,anim_5_addr,anim_6_addr,anim_7_addr,anim_8_addr,CONTROL,memPath);
