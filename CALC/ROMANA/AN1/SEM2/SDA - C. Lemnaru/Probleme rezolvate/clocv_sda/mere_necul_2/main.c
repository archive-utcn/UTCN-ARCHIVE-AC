/*40. Pe o creanga de mar, se afla n mere, fiecare caracterizat prin distanta hi în cm de la pamânt pâna la
pozitia în care se afla si prin greutatea sa gi în grame. Un culegator doreste sa culeaga o cantitate
exprimata în grame cât mai mare de mere. Dupa ce este cules un mar întreaga creanga devine mai usoara
si se ridica în sus cu x cm. Culegatorul ajunge doar la merele aflate la o înaltime mai mica sau egala cu d
cm. Sa se determine greutatea maxima de mere care poate fi culeasa si ordinea în care sunt culese merele.
...
void culege()
{
    // pana mea, consideram ca creanga e la distanta 0 fata de sol
    // asa, ca e o creanga bleaga ca pulile voastre
...
int main()
{
    // sa imi bag pula in hp
    citire();

    // mie mi s-a futut laptopul si voi culegeti mere
    culege();
